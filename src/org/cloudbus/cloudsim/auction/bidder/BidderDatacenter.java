...
public class BidderDatacenter extends Datacenter implements Bidder{
	...
	public static HashMap<String, ArrayList> record= new HashMap<String, ArrayList>(); //to record the winner SPs and their users;
	
	
	public BidderDatacenter(String name,DatacenterCharacteristics characteristics, VmAllocationPolicy vmAllocationPolicy, 
			List<Storage> storageList, double schedulingInterval, int ReputationStatus) throws Exception {
		super(name, characteristics, vmAllocationPolicy, storageList,schedulingInterval, ReputationStatus);
